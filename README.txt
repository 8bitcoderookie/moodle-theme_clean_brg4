...
This document describes how to copy and customise the Clean_BRG4 (bootstrapbase) theme so that
...
From your Moodle theme directory right click on clean_brg4 and then copy and paste back
into your Moodle theme directory. You should now have a folder called Copy of clean_brg4.
...
underscores. For the purpose of this tutorial we will call the theme 'clean_brg4theme'.

On opening 'clean_brg4theme' your you will find several files and sub-directories which have
files within them.
...
where the old theme name occurs, in this case clean_brg4. So using the above list as
a guide, search through and change all the instances of the theme name
'clean_brg4' to 'clean_brg4theme'. This includes the filename of the lang/en/theme_clean_brg4.php.
You need to change this to 'theme_clean_brg4theme.php'.
...
and then click on (Clean_BRG4theme) or whatever you renamed your theme to,
from the list of theme names that appear at this point in the side block.

Customisation using custom theme settings
-----------------------------------------

The settings page for the Clean_BRG4 theme can be located by navigating to:

Administration > Site Administration > Appearance > Themes > Clean_BRG4

Moodle documentation
--------------------

Further information can be found on Moodle Docs: http://docs.moodle.org/dev/Clean_BRG4_theme
